...
airflow_home='/opt/airflow/talendjobs/extracts' #Modified 7/2/2024
job_name='6_emp_load_to_snw'
job_version='0.1'
...
talend_job = airflow_home+"/"+job_name+"_"+job_version+"/"+job_name+"/"+job_name+"_run.sh --context_param connection=/opt/airflow/talendjobs/parameters/snowflake_conn1.csv" #Modified 7/2/2024
...
dag = DAG(job_name, 
          ...
          description='Section : Talend introduction. Lecture : Build sample job : Schedule using airflow.',
          tags=["Udemy"])
