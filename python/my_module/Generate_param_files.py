...
parameters_path = '/opt/airflow/talendjobs/parameters/' #Modified 8/2/2024
copy_df = pd.read_csv('/opt/airflow/talendjobs/job_register/copy_task_register.csv') #Modified 8/2/2024
elt_df = pd.read_csv('/opt/airflow/talendjobs/job_register/elt_task_register.csv') #Modified 8/2/2024
